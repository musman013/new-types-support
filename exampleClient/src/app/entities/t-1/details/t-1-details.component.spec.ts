...
import { IT1, T1Service, T1DetailsComponent, T1ListComponent } from '../';
...
describe('T1DetailsComponent', () => {
  let component: T1DetailsComponent;
  let fixture: ComponentFixture<T1DetailsComponent>;
  let el: HTMLElement;
  ...
  describe('Unit Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [T1DetailsComponent, DetailsComponent],
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T1DetailsComponent);
  ...
  describe('Integration Tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [T1DetailsComponent, T1ListComponent, DetailsComponent, ListComponent, FieldsComp].concat(
          EntryComponents
        ),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            { path: 't1', component: T1DetailsComponent },
            { path: 't1/:id', component: T1ListComponent },
          ]),
        ],
        providers: [T1Service],
      }).compileComponents();
