...
import { IT1, T1Service, T1DetailsComponent, T1ListComponent, T1NewComponent } from '../';

describe('T1ListComponent', () => {
  let fixture: ComponentFixture<T1ListComponent>;
  let component: T1ListComponent;
  let el: HTMLElement;
  ...
  let data: IT1[] = [...constData];

  describe('Unit tests', () => {
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [T1ListComponent, ListComponent],
        imports: [TestingModule],
        providers: [T1Service, ChangeDetectorRef],
        schemas: [NO_ERRORS_SCHEMA],
      }).compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(T1ListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 't1', component: T1ListComponent },
            { path: 't1/:id', component: T1DetailsComponent },
          ]),
        ],
        providers: [T1Service, ChangeDetectorRef],
      }).compileComponents();
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(
        `/t1/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`
      );
    });
